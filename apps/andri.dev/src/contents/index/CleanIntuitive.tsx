...
const content: Array<Content> = [
  {
    ...
    description: 'Implementing advanced threat analysis to proactively identify and mitigate cyber risks.',
  },
  {
    state: 'spacing',
    shows: ['typography', 'spacing'],
    title: 'Network Security Architecture',
    description: 'Designing network infrastructure with layered security, ensuring resilience against emerging threats.',
  },
  {
    state: 'colors',
    shows: ['typography', 'spacing', 'colors'],
    title: 'Data Protection & Privacy',
    description: 'Employing rigorous data protection protocols to safeguard sensitive information and maintain compliance.',
  },
  {
    state: 'effects',
    shows: ['typography', 'spacing', 'colors', 'effects'],
    title: 'Continuous Monitoring & Response',
    description: 'Providing 24/7 monitoring and rapid incident response to ensure uninterrupted security.',
  },
];
  ...
  return (
    <>
      <header className={clsx('mb-8')}>
        <SectionTitle
          title="Dedicated to Robust, Adaptive, and Client-Centric Cybersecurity Solutions"
          caption="Clean & Intuitsive"
          description="Delivering cybersecurity measures that are both cutting-edge and user-focused, without compromising on protection."
        />
      </header>
      <SectionContent>
