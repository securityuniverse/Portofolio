...
caption: Plugin
githubUrl: https://github.com/pwnosec/tailwindcss-accent
...
See the [configuration](https://github.com/pwnosec/andri.dev/blob/a6078ba395ea65cc9c1a7ea524adb29b9580406d/apps/andri.dev/tailwind.config.js#L54-L57) file and [implementation](https://github.com/pwnosec/andri.dev/blob/a6078ba395ea65cc9c1a7ea524adb29b9580406d/apps/andri.dev/src/providers/ColorAccentProvider.tsx#L18-L20) code for details.
